...
namespace Dtol.Migrations
{
    ...
    [Migration("20201215072607_foodsuggest")]
    partial class foodsuggest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dtol.dtol.Bus_Scan_Record", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Dtol.dtol.ComAttachs", b =>
                {
                    ...
                    b.Property<string>("Createmodifytime");
                    ...
                    b.Property<string>("Formtablename");

                    b.Property<int?>("HrDeptId");
                    ...
                    b.ToTable("ComAttachs");
                });

            modelBuilder.Entity("Dtol.dtol.Commodity_Attachs", b =>
                {
                    b.Property<string>("id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("Dtol.dtol.Integral_Commodity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50);
                    ...
                    b.Property<string>("CommodityIntroduction")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("Dtol.dtol.Product_List", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50);
                    ...
                    b.Property<string>("CommodityNum")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("Dtol.dtol.Suggest_Box", b =>
                {
                    ...
                    b.Property<string>("SuggestChildenType");
            ...
            modelBuilder.Entity("Dtol.dtol.Suggest_Box_Type", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Dtol.dtol.User_Test", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Dtol.dtol.ComAttachs", b =>
                {
                    b.HasOne("Dtol.dtol.User_Depart", "HrDept")
                        .WithMany()
                        .HasForeignKey("HrDeptId");

                    b.HasOne("Dtol.dtol.User_Depart", "UploadUser")
                        .WithMany()
