...
namespace ViewModel.RepairsViewModel.RequestViewModel
{
    public class FlowInfoSearchViewModel
    {
        ...
        /// <summary>
        /// 当前节点id（上次调用本方法给前台返回（Flow_NextNodeDefineId））
        /// </summary>
        public int Flow_NodeDefineId { get; set; }

        /// <summary>
        /// 父节点id（上次调用本方法给前台返回（Id））
        /// </summary>
        ...
        /// <summary>
        /// 当前节点操作人员（开始和拟文节点的时候该值为调用增加表单的时候获取的表单上用户Id,其他的节点是根据节点查人员列表获取的）
        /// </summary>
        public int User_InfoId { get; set; }

        /// <summary>
        /// 父节点操作人员(开始节点的时候该值为空（上次调用本方法给前台返回（Pre_User_InfoId））)
        /// </summary>
        ...
        /// <summary>
        /// 提交时间（开始节点 StartTime=EndTime，其他节点都为，数据默认为当前提交时间）
        /// </summary>
